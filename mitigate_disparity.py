...
class BiasRemoverModel:
    ...
    def fit(self, dataset):
        ...
        rw = AjkReweighing(unprivileged_groups,privileged_groups)
...
class AjkReweighing(Transformer):
    ...
    def __init__(self, unprivileged_groups, privileged_groups):
        ...
        """
        super(AjkReweighing, self).__init__(
    ...
    def _obtain_conditionings(self, dataset):
        ...
        for sample_index in range(len(dataset.protected_attributes)):
            ...
            for group in self.privileged_groups:
                ...
                if protect_feature[index] == val:
                    this_sample_protect_level = this_sample_protect_level + level
            protect_level_dic[
